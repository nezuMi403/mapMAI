...
add_graph = ["S_GA_2_k_(200...214,216,218,200V)", "S_GA_2_p_(1...28)", "S_GA_2_e_(1...4)", "S_GA_2_l_1U",
             ...
             "S_GA_3_l_4D", "S_GA_3_p_(1...39)", "S_GA_3_k_(1...14,12A,12B)", "S_GA_3_h_1l", "S_GA_3_h_1r",
             ...
             "S_GB_6_l_(1...4)", "S_GB_6_t_m", "S_GB_6_t_w"]
add_points = {}
nodes = []
            ...
            for action in do.split(","):
                if "..." in action:
                    ...
                    for i in range(start, stop + 1):
                        nodes.append(sample_node + str(i) + "U")
                        nodes.append(sample_node + str(i) + "D")
                else:
                    nodes.append(sample_node + action + "U")
                    nodes.append(sample_node + action + "D")
        elif "(" in node:
            do = node.split("(")[1].split(")")[0]
            sample_node = node.split("(")[0]
            for action in do.split(","):
