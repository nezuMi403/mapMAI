...
def make_dictionar_of_points(sp_s:list, sl:dict) -> dict:
    ...
    for s in sp_s:
        ...
        for point in points:
            ...
            for point_neightbor in init_graph[point_name].keys():
...
def return_shortest_path(input_point:str, output_point:str) -> list:
    ...
    sp_result = print_result(previous_nodes, shortest_path, start_node=input_point, target_node=output_point)
    return sp_result
...
sp_result = return_shortest_path(start, end)
print("!!!!   ", sp_result)
